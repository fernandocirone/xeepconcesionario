...
namespace xeepconcesionario.Controllers
{
    public class SucursalesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,NombreSucursal,Direccion")] Sucursal sucursal)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NombreSucursal,Direccion")] Sucursal sucursal)
        {
            if (id != sucursal.Id)
            {
                return NotFound();
